<?php 
/**
 * Clase que envia un correo electronico al usuario del formulario
 * de contacto dentro del proyecto
 */
class SendEmails {
  /**
  ...
  public static function send($addAdress, $name, $subjet, $body) {
    ...
    try {
        ...
        $mail->addAddress($addAdress, $name);    
    
        // Contenido
        $mail->isHTML(true);             // Establecer formato de correo electrónico en HTML
        $mail->Subject = $subjet;        // Establece el contenido del correo electornico
